...
*   $Date: 2012-01-13 00:40:56 +0800 (Fri, 13 Jan 2012) $                     *
*                                                                            *
\*===========================================================================*/
...
initializePlugin()
{
  if ( OpenFlipper::Options::gui() ) {
    ...
    toolIcon_ = new QIcon(OpenFlipper::Options::iconDirStr()+OpenFlipper::Options::dirSeparator()+"LBC2.png");
    emit addToolbox( tr("LBC") , tool_, toolIcon_ );
  }
}
...
slot_smooth()
{
  ...
  for ( PluginFunctions::ObjectIterator o_it(PluginFunctions::TARGET_OBJECTS,DATA_TRIANGLE_MESH) ;
    ...
    LBCObject* data = dynamic_cast< LBCObject* > ( o_it->objectData(SMOOTHER) );
...
*/
void LBCPlugin::smooth(int _objectId , int _iterations , QString _direction , QString _continuity, double _maxDistance) {
  ...
  if ( baseObjectData->dataType() == DATA_TRIANGLE_MESH ) {
    ...
    LBCObject* data = dynamic_cast< LBCObject* > ( object->objectData(SMOOTHER) );
...
Q_EXPORT_PLUGIN2( LBCPlugin , LBCPlugin );

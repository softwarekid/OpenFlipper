/****************************************************************************
** Meta object code from reading C++ file 'DoubleWidget.hh'
**
...
#include "../../Plugin-PropertyVis/Widgets/DoubleWidget.hh"
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'DoubleWidget.hh' doesn't include <QObject>."
...
void *DoubleWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::DoubleWidget"))
        return static_cast< Ui::DoubleWidget*>(const_cast< DoubleWidget*>(this));

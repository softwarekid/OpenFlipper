/****************************************************************************
** Meta object code from reading C++ file 'infoDialog.hh'
**
...
#include "../../Plugin-InfoMeshObject/infoDialog.hh"
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'infoDialog.hh' doesn't include <QObject>."
...
void *InfoDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::InfoWidget"))
        return static_cast< Ui::InfoWidget*>(const_cast< InfoDialog*>(this));

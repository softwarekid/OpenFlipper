/****************************************************************************
** Meta object code from reading C++ file 'TreeModel.hh'
**
...
#include "../../Plugin-Datacontrol/TreeModel.hh"
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'TreeModel.hh' doesn't include <QObject>."
...
static const char qt_meta_stringdata_TreeModel[] = {
    "TreeModel\0dataChangedInside(int,int,QVariant)\0"
    "_id,_column,_value\0\0moveBaseObject(int,int)\0"
    "_id,_newParentId\0"
};
...
void TreeModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->moveBaseObject((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
    }
}
...
// SIGNAL 0
void TreeModel::dataChangedInside(int _t1, int _t2, const QVariant & _t3)
{
...
// SIGNAL 1
void TreeModel::moveBaseObject(int _t1, int _t2)
{

/****************************************************************************
** Meta object code from reading C++ file 'ConversionDialog.hh'
**
...
#include "../../../PluginCollection-Selection/Plugin-SelectionMeshObject/ConversionDialog.hh"
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'ConversionDialog.hh' doesn't include <QObject>."
...
const QMetaObject ConversionDialog::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ConversionDialog,
...
void *ConversionDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::ConversionDialog"))
        return static_cast< Ui::ConversionDialog*>(const_cast< ConversionDialog*>(this));
